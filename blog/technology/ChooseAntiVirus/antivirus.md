...
* 看别人杀软搭配着用自己也跟着盲目来，觉得杀软下的越多越强。其实不是的，杀毒搭配是要达到一个1+1=2甚至是＞2的效果，阴阳互补，而错误的搭配可能会1+1＜2。举个例子，合理的搭配比如说可以用eset+冰盾或者其他主防强的使用，不合理的则是卡巴+bd这种卡上天的组合，bd和卡巴单拿出来一个都很全面，但是放在一起很多防护会重叠重复吃资源，回滚时还可能出bug
...
* 火绒始终不肯引入驱动级主防，虽然这么做也有道理，一定程度上降低了系统出现底层故障的风险（之前全球大规模蓝屏就是CrowdStrike驱动bug的锅），但是代价的防护的脆弱
...
* 据说还有磁盘读写量大问题，不知道有没有解决，好像我这边在进行大量样本扫描时确实会很卡
...
Avira Protection Cloud，红伞的云启发）和联动响应的很快，个人觉得红伞现在很大部分就是APC撑着。还有个sentry主防，但是免费版的貌似是残血的，有回滚但强度也不是很高。
...
不过现在用红伞的厂商不多了。根据一些人的猜测，如果越来越多厂商放弃红伞转自研，那么gen很可能会放弃红伞的架构替换为avast技术，到那时可能就再也见不到原汁原味的红伞了。

**优点：**

* APC启发不错，sentry主防好像也还行
...
* 简中字体显示有问题，甚至繁中都没有这个问题

* 误报高，国内水土不服

* 一些操作习惯上可能国内用户适应不来，比如打游戏没有专门的游戏/免扰模式，扫到毒还会开始无法中止的快速扫描

## BitDefender

[![BitDefender](antivirus-BitDefender.jpg)](https://www.bitdefender.com/)

这个名声不小，但是国内没啥热度，这家杀软也不怎么重视国内市场（可能还是因为国内盗版横行的刻板印象吧）。但是强度在民间是有口皆碑的，ATD主防在个人杀软里算比较灵敏的，有一个不太完善的回滚，不过没有HIPS，是纯多步主防。常年位居国外一线杀软。

但是我个人认为还是瑜不掩瑕，首先不重视国内市场就是个很大的问题，在国内使用会有诸多不方便，比如说下载和更新困难，账号登录需要魔法，云有时连不上，甚至企业版都有简中个人版没有，个人版只配用繁中。资源占用也是常被诟病的一点，我这边装上就卡卡的，日常占用600m左右，算是个人杀软独一档了。而且多多少少也有一点扣，现在个人杀软用机学的很多，就bd的机学还是只给企业版用不给个人版下发。引擎和云只能说一般般，强度更多是ATD主防撑起来的。在国内误报很多，破解和修改器通常都不会放过。

总的来说bd还是不错的，免费版已经给了ATD主防（但是没有勒索防护），日用还是够的，可惜用户体验做的确实不太好，建议各位还是放虚拟机里，需要测毒的时候再用吧，实体机有生产力需求还是不建议长期装bd的。如果确实想使用请不要去中国官网，那里只供应企业版。
...
[![Norton](antivirus-Norton.png)](https://cn.norton.com/)

也是一款老牌杀软了。老诺顿用的是赛门铁克技术，实力很不错，可惜成了过去式。新版Norton的核心技术已经是avast的技术了，所以综合防护可能和avast大差不差。

但是诺顿和avast还是有些有意思的区别，就比如今年AV-C六月的真实世界保护测试中我记得avast因为误报得的奖次比诺顿低一个档次，可能云还是自家的。但总的来说大差不差，可以看喜好买，不过诺顿没有免费版~~（想起了之前在官网很难绷的一句：如果我们的专家无法修复您受感染的计算机，我们会全额退款，这是免费杀毒软件不能保证的）~~，avast有。
...
* 即使在测试中误报控制比avast好，但是实际上误报还是不少的

* 性能控制这一块不太好

## Dr.Web（大蜘蛛）

[![Dr.Web](antivirus-Dr.Web.png)](https://www.drweb.cn/)